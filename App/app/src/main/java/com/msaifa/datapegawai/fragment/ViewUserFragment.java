package com.msaifa.datapegawai.fragment;
...
import com.msaifa.datapegawai.model.UserList;
...
import com.msaifa.datapegawai.adapter.UserListViewAdapter;
...
public class ViewUserFragment extends Fragment {
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		getActivity().setTitle("Data Pegawai");
		bindView();
		init();
		onCreateSwapview();
		addListner();
